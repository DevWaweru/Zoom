...
## Description
[Zoom]((https://zoooom.herokuapp.com)) is a simple photo gallery web application to showcase beautiful pictures and designs. Users get to view photos updated by the site admin. Users can see photos based on the location, by clicking on the listed locations in the menu. They can also copy the link to a photo to paste at their discretion. The search functionality will search photos based on the categories. 

## Specifications
Get the specs [here](https://github.com/DevWaweru/Zoom/blob/master/SPECS.md)
